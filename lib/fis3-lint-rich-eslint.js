...
fis.set('eslintResult', {});
fis.set('eslintResult.errCount', 0);
fis.set('eslintResult.totalCount', 0);
...
module.exports = function (content, file, conf) {
    ...
    if (report.errorCount || report.warningCount) {
        ...
        // 导出异常信息条数
        fis.set('eslintResult.errCount', result.errCount);
        fis.set('eslintResult.totalCount', result.totalCount);
        return;
    }
